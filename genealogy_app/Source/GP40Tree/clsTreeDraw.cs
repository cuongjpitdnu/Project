...
namespace GP40Tree
{
    class clsTreeDraw
    {
        ...
        public void MakeTreeDraw(int intRootID, float intMinTop, float intMinLeft)
        {
        ...
        /// <param name="hasMember"></param>
        /// <param name="enSpousePos"></param>
        public void MakeTreeDrawWithSpouse(int intRootID, float intMinTop, float intMinLeft, clsConst.ENUM_FIRSTSPOUSE_POSITION enSpousePos = clsConst.ENUM_FIRSTSPOUSE_POSITION.RightMember)
        {
            clsFamilyMember objRoot = (clsFamilyMember)hasMember[intRootID];
            if (objRoot.blnPos) return;
            objRoot.miPosition.Y = intMinTop;
