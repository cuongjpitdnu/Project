...
#End Region
    ...
    Private mobjTempSelectedCard As usrMemberCard3      'temporary selected card
    ...
    Private Function xDisposeCard(ByVal mtblCards As Hashtable) As Boolean
        ...
        Dim objCard As usrMemberCard3 = Nothing

        Try
            'dipose control in hastable
            For Each element As DictionaryEntry In mtblCards

                objCard = CType(element.Value, usrMemberCard3)
    ...
    '        Dim objCard2 As usrMemberCard3
    '        Dim i As Integer
    '        For Each element As DictionaryEntry In mtblCardInfo
    '            stCard = CType(mtblCardInfo.Item(element.Key), stCardInfo)
    '            objCard = CType(mtblCardCtrl.Item(element.Key), usrMemberCard3)

    '            If Not stCard.lstSpouse Is Nothing Then
    '                For i = 0 To stCard.lstSpouse.Count - 1
    '                    objCard2 = CType(mtblCardCtrl.Item(stCard.lstSpouse(i)), usrMemberCard3)
    ...
    '                    objCard2 = CType(mtblCardCtrl.Item(stCard.lstChild(i)), usrMemberCard3)
    ...
    Private Sub xAddHandler(ByRef objCard As usrMemberCard3)
        AddHandler objCard.evnCardDoubleClick, AddressOf xShowPerInfo
        AddHandler objCard.evnCardClick, AddressOf xCardClicked
        'AddHandler objCard.evnNotDraw, AddressOf xHandleNotDraw
        AddHandler objCard.evnCardLocationChange, AddressOf xCardMove
    ...
    Private Function xAddCtrl2Panel() As Boolean
        ...
        Try
            ...
            For Each element As DictionaryEntry In mtblCardInfo
                ...
                stCard = CType(mtblCardInfo.Item(element.Key), stCardInfo)
                objCard = fncMakeCardInfoType3(stCard, mblnIsSmallCard)
    ...
    Private Sub xCardClicked(ByVal intMemID As Integer)
        ...
        Try
            ...
            objCard = CType(mtblCardCtrl.Item(intMemID), usrMemberCard3)
    ...
    Private Function xSetScrollView(ByVal intRootID As Integer, Optional ByVal blnSetSelected As Boolean = False) As Boolean
        ...
        Try
            ...
            objCard = CType(mtblCardCtrl.Item(intRootID), usrMemberCard3)
            'objCard = CType(gtblMemberCard.Item(intRootID), usrMemberCard3)
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function xSetSelected(ByVal objCard As usrMemberCard3) As Boolean
    ...
    '      UPDATE     : 
    '   ******************************************************************
    Private Sub xDrawDiffLv(ByVal objUpperCard As usrMemberCard3, ByVal objLowerCard As usrMemberCard3)
    ...
    '      UPDATE     : 
    '   ******************************************************************
    Private Sub xDrawSameLv(ByVal objLeftCard As usrMemberCard3, ByVal objRightCard As usrMemberCard3)
        Try
            Dim intLen As Integer
    ...
    Private Sub xSetCardSize()
        ...
        Try
            ...
            mintMEM_CARD_W = 65  'clsDefine.MEM_CARD_W_S
            mintMEM_CARD_H = 160 'clsDefine.MEM_CARD_H_S
