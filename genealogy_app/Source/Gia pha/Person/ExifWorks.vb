...
#Region " Support methods for working with EXIF properties "
    ...
    Public Function Save(ByVal newFileName As String) As Boolean

        Save = False
        _Image.Save(newFileName, System.Drawing.Imaging.ImageFormat.Jpeg)
        Me.Dispose()
        Return True

    End Function

    Public Function Save(ByVal vstrFile As String, _
                         ByVal vstrnewFileName As String, _
                         ByVal size As System.Drawing.Size) As Boolean
        Save = False
        If vstrFile = "" Or vstrnewFileName = "" Then Exit Function

        _Image = Image.FromFile(vstrFile)
        _Image = xResizeImage(_Image, size)

        _Image.Save(vstrnewFileName, System.Drawing.Imaging.ImageFormat.Jpeg)
