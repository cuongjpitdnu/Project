...
namespace GP40Tree
{
    class clsFInputTree : IDisposable
    {
        ...
        public void DrawInputTree(SKCanvas canvas)
        {
            ...
            objFather.DrawingInputSVGMember();
            objMother.DrawingInputSVGMember();
            objMemberLeft.DrawingInputSVGMember();
            objMemberSpouse.DrawingInputSVGMember();

            canvas.DrawPicture(objFather.miSvgData.Picture, objFather.miPosition.X, objFather.miPosition.Y, paint);
            canvas.DrawPicture(objMother.miSvgData.Picture, objMother.miPosition.X, objMother.miPosition.Y, paint);
            canvas.DrawPicture(objMemberLeft.miSvgData.Picture, objMemberLeft.miPosition.X, objMemberLeft.miPosition.Y, paint);
            canvas.DrawPicture(objMemberSpouse.miSvgData.Picture, objMemberSpouse.miPosition.X, objMemberSpouse.miPosition.Y, paint);
