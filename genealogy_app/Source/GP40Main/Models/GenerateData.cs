    ...
    public class GenerateData
    {
        ...
        public static List<DataBinding<int>> GetListGender()
        {
            return new List<DataBinding<int>>()
            {
                ...
                new DataBinding<int>() { Display = "Nam", Value = (int)AppConst.GenderMember.Male },
                new DataBinding<int>() { Display = "Nữ", Value = (int)AppConst.GenderMember.Female },
                new DataBinding<int>() { Display = "Chưa rõ", Value = (int)AppConst.GenderMember.Unknown },
            };
        }
