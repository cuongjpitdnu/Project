...
namespace GP40Main.Themes.Controls
{
    public partial class MenuItem : UserControl
    {
        ...
        public void Add(string Title, ItemBase Content)
        {
        ...
        //    foreach(KeyValuePair<string, ItemBase> key in ListControl)
        //    {
        //        Item item = new Item(NumItem, key);
        //        item.Tag = NumItem;
        //        item.Click += new System.EventHandler(this.OnClick);
        //        item.Dock = DockStyle.Top;
        //        NumItem++;
        //        items.Add(item);
        //    }
    ...
    public class ItemHeader : UserControl
    {
        ...
        public ItemHeader(int idMenu, KeyValuePair<string, ItemBase> control)
        {
            ...
            btnHeader.FlatAppearance.MouseDownBackColor = Color.SeaShell;
            btnHeader.FlatAppearance.MouseOverBackColor = Color.SeaShell;
