...
namespace MaterialSkin.Controls
{
    public class MaterialColorPicker : Control, IMaterialControl
    {
        ...
        public Color BackColor { get { return SkinManager.BackgroundCardColor; } set{} }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            DrawHelper.drawShadow(g, objShadowPath, 20, BackColor);
    ...
    class MaterialColorSlider : Control, IMaterialControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            g.Clear(SkinManager.BackgroundCardColor);
            Color LineColor;
            Brush DisabledBrush;
            Color BalloonColor;
            ...
            g.DrawString(Beschreibung, SkinManager.getFontByType(MaterialSkinManager.fontType.Overline), SkinManager.TextHighEmphasisBrush, DescriptioRectangle, new StringFormat { Alignment = StringAlignment.Center, LineAlignment = StringAlignment.Center });
            g.DrawString(Value.ToString(), SkinManager.getFontByType(MaterialSkinManager.fontType.Overline), SkinManager.TextHighEmphasisBrush, ValueRectangle, new StringFormat { Alignment = StringAlignment.Center, LineAlignment = StringAlignment.Center });
