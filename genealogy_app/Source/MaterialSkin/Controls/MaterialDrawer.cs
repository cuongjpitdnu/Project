namespace MaterialSkin.Controls
{
    ...
    public class MaterialDrawer : Control, IMaterialControl
    {
        ...
        private void preProcessIcons()
        {
            ...
            ImageAttributes grayImageAttributes = UseImageAttributes ? new ImageAttributes() : null;
            ImageAttributes colorImageAttributes = UseImageAttributes ? new ImageAttributes() : null;
            ...
            grayImageAttributes?.Dispose();
            colorImageAttributes?.Dispose();
        }
