...
namespace GPMain.Common.Dialog
{
    public partial class EventDetails : Form
    {
        ...
        public EventDetails(DateTime date = new DateTime())
        {
            InitializeComponent();
        ...
        private void BtnFontClick(object sender, EventArgs e)
        {
            ...
            if (dr == DialogResult.OK)
            {
                ...
                lblFont.Text = $"{fontDialog1.Font.Name},{fontDialog1.Font.Size.ToString(CultureInfo.InvariantCulture)}pt";
            }
        }
