...
namespace GPCommon
{
    ...
    public static class EncryptHelper
    {
        ...
        public static void ToFileEncrypt(this string data, string path, string key)
        {
            File.WriteAllText(path, Encrypt(data, key));
        }

        public static string ReadFileDecrypt(string path, string key)
        {
            if (File.Exists(path))
            {
