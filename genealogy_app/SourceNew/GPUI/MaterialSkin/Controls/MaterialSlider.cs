...
namespace MaterialSkin.Controls
{
    public partial class MaterialSlider : Control, IMaterialControl
    {
        ...
        public Color BackColor { get { return Parent == null ? SkinManager.BackgroundColor : Parent.BackColor; } }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            g.DrawString(MinValue.ToString(), SkinManager.getFontByType(MaterialSkinManager.fontType.Overline), SkinManager.TextHighEmphasisBrush, new PointF(0, 0));
            g.DrawString(MaxValue.ToString(), SkinManager.getFontByType(MaterialSkinManager.fontType.Overline), SkinManager.TextHighEmphasisBrush, new PointF(Width - g.MeasureString(MaxValue.ToString(), SkinManager.getFontByType(MaterialSkinManager.fontType.Overline)).Width, 0f));
            g.DrawString(Value.ToString(), SkinManager.getFontByType(MaterialSkinManager.fontType.Overline), SkinManager.TextHighEmphasisBrush, new PointF(Width / 2 - g.MeasureString(Value.ToString(), SkinManager.getFontByType(MaterialSkinManager.fontType.Overline)).Width / 2, 0f));
