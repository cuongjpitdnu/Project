namespace MaterialSkin.Controls
{
    ...
    public class MaterialTextBox : RichTextBox, IMaterialControl
    {
        ...
        [Category("Material Skin"), DefaultValue(false)]
        public bool ModeNumber { get; set; }
        [Category("Material Skin"), DefaultValue(false)]
        public bool ModeNumber_CheckMinimum { get; set; }
        [Category("Material Skin"), DefaultValue(false)]
        public bool ModeNumber_CheckMaximum { get; set; }

        [Category("Material Skin"), DefaultValue(0)]
        public int ModeNumber_Minimum { get; set; }

        [Category("Material Skin"), DefaultValue(100)]
        public int ModeNumber_Maximum { get; set; } = 999999;
        ...
        public MaterialTextBox()
        {
            ...
            this.KeyPress += (sender, e) =>
            {
                if (ModeNumber)
                {
                    if (!int.TryParse(e.KeyChar.ToString(), out int number))
                    {
                    ...
                    else
                    {
                        ...
                        int.TryParse(Text + e.KeyChar.ToString(), out int val);
                        if ((ModeNumber_CheckMinimum && val < ModeNumber_Minimum) || (ModeNumber_CheckMaximum && val > ModeNumber_Maximum))
                        {
                            e.KeyChar = (char)Keys.None;
                        }
                    }
