namespace MaterialSkin.Controls
{
    ...
    public class MaterialForm : Form, IMaterialControl
    {
        ...
        private Color _BackColorStatusBar = Color.Transparent;
        [Browsable(false)]
        public Color BackColorStatusBar
        {
            get
            {
                return _BackColorStatusBar;
            }
            set
            {
                _BackColorStatusBar = value;
                this.Refresh();
            }
        }
        ...
        protected const int STATUS_BAR_HEIGHT = 24;
        ...
        [Category("Drawer")]
        public bool UseImageAttributes { get; set; }
        ...
        protected void AddDrawerOverlayForm()
        {
            ...
            drawerControl.UseImageAttributes = UseImageAttributes;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            g.FillRectangle(BackColorStatusBar == Color.Transparent ? SkinManager.ColorScheme.DarkPrimaryBrush : new SolidBrush(BackColorStatusBar), _statusBarBounds);
