...
namespace MaterialSkin.Controls
{
    public partial class DropDownControl : UserControl, IMaterialControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            Brush LineBrush = (MouseState == MouseState.HOVER ? SkinManager.ColorScheme.PrimaryBrush : SkinManager.DividersBrush);

            using (Brush b = new SolidBrush(this.BackColor))
            {
                e.Graphics.FillRectangle(new SolidBrush(SkinManager.BackgroundColor), ClientRectangle);
            }
            ...
            TextRenderer.DrawText(e.Graphics, _Text, SkinManager.getFontByType(MaterialSkinManager.fontType.Caption), this.AnchorClientBounds, SkinManager.ColorScheme.TextColor, TextFormatFlags.WordEllipsis);
        }
