namespace MaterialSkin
{
    ...
    public class MaterialSkinManager
    {
        ...
        private MaterialSkinManager()
        {
            ...
            logicalFonts.Add("Button", createLogicalFont("Helvetica", 14, NativeTextRenderer.logFontWeight.FW_BOLD));
        ...
        // Card
        private static readonly Color BACKGROUND_CARD_BLACK = Color.FromArgb(255, 42, 42, 42);
        private static readonly Color BACKGROUND_CARD_WHITE = Color.White;
        ...
        // Card
        public Color BackgroundCardColor => Theme == Themes.LIGHT ? BACKGROUND_CARD_WHITE : BACKGROUND_CARD_BLACK;
