...
return [
    ...
    */
    ...
    'alpha'                => ':attribute は文字のみ有効です',
    'alpha_dash'           => ':attribute は記号以外の「文字」「数字」「-(ダッシュ)」「_(下線)」のみ有効です',
    'alpha_num'            => ':attribute は記号以外の「文字」「数字」のみ有効です',
    ...
    'date_format'          => ':attribute を有効な日付形式にしてください',
