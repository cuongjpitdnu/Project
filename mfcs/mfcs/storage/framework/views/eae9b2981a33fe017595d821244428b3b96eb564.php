...
$(function(){
	...
	$('#save').on('click', function(){
		if( $('input[name=method]').val() == 'create'){
			...
			$.ajax({
				type:'POST',
				url:'<?php echo e(url("/")); ?>/mst/member/checkinsert',
				dataType:'json',
				...
				var msg = null;
				if(existsEqual == true){
					msg = '<?php echo e(config("message.msg_member_if_001")); ?>'
				}
				...
				var url = '<?php echo e(url("/")); ?>/<?php echo e($menuInfo->KindURL); ?>/<?php echo e($menuInfo->MenuURL); ?>/insert';
		...
		if( $('input[name=method]').val() == 'edit' ) {
			var url = '<?php echo e(url("/")); ?>/<?php echo e($menuInfo->KindURL); ?>/<?php echo e($menuInfo->MenuURL); ?>/update';
			$('#mainform').attr('action', url);
			$('#indicator').trigger('click');
			$('#mainform').submit();
		}
	...
	$('#cancel').on('click', function(){
		$('#indicator').trigger('click');
		var val4 = encodeURIComponent('<?php echo e($request->val4); ?>');
		var val5 = encodeURIComponent('<?php echo e($request->val5); ?>');
	...
	<div class="col-xs-12">
		...
		<div class="row align-items-center">
			<div class="col-xs-1 text-left m-2 p-2 rounded border">
				■　人員マスタ<?php if($target === 'show'): ?>参照<?php elseif($target === 'create'): ?>登録<?php elseif($target === 'edit'): ?>更新<?php endif; ?>
			</div>
		</div>
		...
		<form action="<?php echo e(url('/')); ?>/<?php echo e($menuInfo->KindURL); ?>/<?php echo e($menuInfo->MenuURL); ?>/historysave" method="POST" id="mainform">
			...
			<?php if($target === 'edit'): ?>
				...
				<input type="hidden" id="val102" name="val102" value="<?php echo e($request->val102); ?>">
			<?php endif; ?>
			...
			<table class="table table-borderless">
				...
				<tr>
					...
					<td>
						<input type="text" name="val401" value="<?php echo e(old('val401', @$mstMember ['val401'])); ?>"
						<?php echo e($target === "show" ? 'disabled="disabled"' : ''); ?> autocomplete="off" maxlength="50">
					</td>
					<td class="p-0 align-middle">
						<span class="col-xs-1 p-1">
						<?php echo $__env->make('layouts/error/item', ['name' => 'val401'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
						</span>
					</td>
					<td class="align-middle">フリガナ *：</td>
					<td>
						<input type="text" name="val402" value="<?php echo e(old('val402', @$mstMember ['val402'])); ?>"
						<?php echo e($target === "show" ? 'disabled="disabled"' : ''); ?> autocomplete="off" maxlength="50">
					</td>
					<td class="p-0 align-middle">
						<span class="col-xs-1 p-1">
						<?php echo $__env->make('layouts/error/item', ['name' => 'val402'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
						</span>
					</td>
				</tr>
				<tr>
					...
					<td>
						<input type="text" name="val403" value="<?php echo e(old('val403', @$mstMember ['val403'])); ?>"
						<?php echo e($target === "show" ? 'disabled="disabled"' : ''); ?> autocomplete="off" maxlength="50">
					</td>
					<td class="p-0 align-middle">
						<span class="col-xs-1 p-1">
						<?php echo $__env->make('layouts/error/item', ['name' => 'val403'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
						</span>
					</td>
					<td class="align-middle">定年退職日：</td>
					<td>
						<input id="" type="text" maxlength="10" name="val404" size="14" value="<?php echo e(old('val404', @$mstMember ['val404'])); ?>" 
						<?php echo e($target === "show" ? 'disabled="disabled"' : ''); ?> class="selectdate" autocomplete="off">
					</td>
					<td class="p-0 align-middle">
						<span class="col-xs-1 p-1">
						<?php echo $__env->make('layouts/error/item', ['name' => 'val404'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
						</span>
					</td>
				</tr>
			<?php if($target === 'create'): ?>
...
<?php /**PATH C:\Xamp\htdocs\mfcs\resources\views/mst/member/contents.blade.php ENDPATH**/ ?>