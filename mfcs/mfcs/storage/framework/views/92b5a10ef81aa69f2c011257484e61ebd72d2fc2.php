	...
	<div class="col-xs-12">
		...
		<div class="row">
			<div class="col-sm-12">
				<table class="table">
					<thead>
						<tr>
							...
							<th class="text-center"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('fld4', '有効'));?></th>
							<th class="text-center"></th>
						</tr>
					</thead>
					<tbody>
					<?php $__currentLoopData = $bDatas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<tr>
						<td class="real-space align-middle"><?php echo e($bData['fld1']); ?></td>
						<td class="real-space align-middle"><?php echo e($bData['fld2']); ?></td>
						<td class="real-space align-middle"><?php echo e($bData['fld3']); ?></td>
						<td class="real-space align-middle"><?php echo e($bData['fld4'] ? '有効' : '無効'); ?></td>
						<td class="text-center align-middle">
							<?php if(!$menuInfo->IsReadOnly): ?>
								<button type="button" class="edit <?php echo e(config('system_const.btn_color_rowedit')); ?>"
								value="<?php echo e(valueUrlEncode($bData['fld1'])); ?>">
				...
				<?php echo e($bDatas->appends(\Request::except('page'))->render()); ?>
...
<?php echo $__env->make('layouts/mainmenu/menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Xamp\htdocs\mfcs\resources\views/Mst/BData/index.blade.php ENDPATH**/ ?>