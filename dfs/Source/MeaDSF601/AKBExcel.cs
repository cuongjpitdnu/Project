    ...
    public class AkbExcel
    {
        ...
        public int CheckExitsSheets(string strNameSheet)
        {
            try
            {
                ...
                var length = Common.CnvNullToInt(Count);
        ...
        public int GetCountSheets()
        {
            try
            {
                ...
                return Common.CnvNullToInt(GetProperty(_mobjWorkSheets, "Count"));
        ...
        public int GetLastRowHasValueOfColumn(string strName)
        {
            ...
            try
            {
                ...
                return Common.CnvNullToInt(_mobjRange);
            }
            catch (Exception e)
            {
                XWriteLogs(MethodBase.GetCurrentMethod().Name, e.Message);
        ...
        public int GetRowsCount()
        {
            try
            {
                ...
                return Common.CnvNullToInt(rowsCount);
            }
            catch (Exception e)
            {
                XWriteLogs(MethodBase.GetCurrentMethod().Name, e.Message);
        ...
        public void CloseExcel()
        {
            ...
            try
            {
                ...
                if (_mobjExcel != null)
                {
                    try
                    {
                        hWnd = Common.CnvNullToInt(GetProperty(_mobjExcel, "Hwnd"));
                        blnHWnd = true;
                    }
                    catch
                    {
