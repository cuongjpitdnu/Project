...
namespace EasyModbus
{
	...
	public partial class ModbusClient
	{
        ...
        public delegate void AkbReceiveDataChanged(int startingAddress, int quantity, int[] response);
        public event AkbReceiveDataChanged akbReceiveDataChanged;
 ...
 */       
        ...
        public int[] ReadInputRegisters(int startingAddress, int quantity)
		{
            ...
            //HIEU Add
            if (akbReceiveDataChanged != null)
            {
                akbReceiveDataChanged(startingAddress, quantity, response);
            }
  ...
  /*      public bool Available(int timeout)
        {
            ...
            System.Net.NetworkInformation. reply = pingSender.Send(address, timeout, buffer);
