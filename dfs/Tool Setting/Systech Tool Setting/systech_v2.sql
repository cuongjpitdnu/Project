...
CREATE TABLE `m_device`  (
  ...
  `port` int(5) NOT NULL,
  `mac_address` char(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `alarm_value` int(6) NOT NULL,
  `period` int(6) NOT NULL,
  `fail_level` int(6) NOT NULL,
  `samples` int(6) NOT NULL,
  `ordinal_display` int(5) NOT NULL,
  `walking_mode` tinyint(4) NULL DEFAULT NULL,
...
INSERT INTO `m_device` VALUES (1, 'Device 1', '192.168.0.1', 10001,'', 500, 90, 700, 5, 1, 0, 1, '2018-09-14 08:21:20');
INSERT INTO `m_device` VALUES (2, 'Device 2', '192.168.0.1', 10001,'', 500, 90, 700, 5, 2, 0, 1, '2018-09-14 08:21:20');
INSERT INTO `m_device` VALUES (3, 'Device 3', '192.168.0.1', 10001,'', 500, 90, 700, 5, 3, 0, 1, '2018-09-14 08:21:20');
INSERT INTO `m_device` VALUES (4, 'Device 4', '192.168.0.1', 10001,'', 500, 90, 700, 5, 4, 0, 1, '2018-09-14 08:21:20');
INSERT INTO `m_device` VALUES (5, 'Device 5', '192.168.0.1', 10001,'', 500, 90, 700, 5, 5, 0, 1, '2018-09-14 08:21:20');
