    ...
    class clsDBUltity : IDisposable
    {
        ...
        public bool ResetDefauleDevice(int deviceid, int devicetype)
        {
            ...
            try
            {
                ...
                deviceData.Add("device_name", clsCommon.CnvNullToString(defaultDevice.Rows[0]["device_name"]));
                deviceData.Add("ip_address", clsCommon.CnvNullToString(defaultDevice.Rows[0]["ip_address"]));
                deviceData.Add("port", clsCommon.CnvNullToInt(defaultDevice.Rows[0]["port"]));
                deviceData.Add("alarm_value", clsCommon.CnvNullToInt(defaultDevice.Rows[0]["alarm_value"]));
                deviceData.Add("period", clsCommon.CnvNullToInt(defaultDevice.Rows[0]["period"]));
                deviceData.Add("fail_level", clsCommon.CnvNullToInt(defaultDevice.Rows[0]["fail_level"]));
                deviceData.Add("samples", clsCommon.CnvNullToInt(defaultDevice.Rows[0]["samples"]));
                deviceData.Add("active", clsCommon.CnvNullToInt(defaultDevice.Rows[0]["active"]));
